        ...
        ZStack {
            ...
            ScrollView {
                ...
                Text("Assets")
                    .font(.custom("ModernAntiqua-Regular", size: 20))
                    .foregroundStyle(.black)
                Text("Assets and textures were created using DALL•E.")
                    .font(.custom("ModernAntiqua-Regular", size: 15))
                    .foregroundStyle(.black)
                    .frame(maxWidth: .infinity, alignment: .leading)
                    .padding(.bottom)
                ...
                Text("Fonts")
                    .font(.custom("ModernAntiqua-Regular", size: 20))
                    .foregroundStyle(.black)
                Text("Modern Antiqua - designed by Wojciech Kalinowski")
                    .font(.custom("ModernAntiqua-Regular", size: 15))
                    .foregroundStyle(.black)
                    .frame(maxWidth: .infinity, alignment: .leading)
                    .padding(.bottom)
                Text("Morris Roman Black - designed by Dieter Steffmann")
