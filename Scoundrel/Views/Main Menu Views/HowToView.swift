        ...
        ZStack {
            ...
            ScrollView {
                ...
                Text("Scoring")
                    .font(.custom("ModernAntiqua-Regular", size: 25))
                    .foregroundStyle(.black)
                Text("At the end of a game, your score is your life minus the sum of the strength of all remaining Monster cards in the deck.")
                    .font(.custom("ModernAntiqua-Regular", size: 15))
                    .foregroundStyle(.black)
                    .frame(maxWidth: .infinity, alignment: .leading)
                    .padding(.bottom)
                Text("If your life is 20 and your last card was a Health Potion, your score is 20 plus the strength of that potion.")
                    .font(.custom("ModernAntiqua-Regular", size: 15))
                    .foregroundStyle(.black)
                    .frame(maxWidth: .infinity, alignment: .leading)
                    .padding(.bottom)
